...
RUN conda install --yes -c conda-forge matplotlib holoviews imbalanced-learn wordcloud mlxtend folium pyldavis pulp jupyterthemes scrapy pyspark sentence-transformers rise
